"""
В соответствии с вашим номером в журнале выведите на экран Имя персонажа и ссылку на него.
"""
...
print(list(characters["2"].keys())[0])
print(list(characters["2"]["Morty Smith"].keys())[0])
print(characters["18"]["Antenna Morty"]["https://rickandmortyapi.com/api/character/18"])